...
slug: topic-tui-corpus-producer.es
...
cites: []
paired_with: topic-tui-corpus-producer.md
---
...
El corpus producido por los operadores de un cliente entrena el adaptador de ese cliente, no un adaptador general. Por la convención [[topic-customer-owned-graph-ip]], los pesos del adaptador entrenado son propiedad del cliente. Foundry distribuye la arquitectura del modelo y el pipeline de entrenamiento; el cliente retiene el adaptador resultante.
...
- [[topic-single-boundary-compute-discipline]] — la TUI nunca llama a los niveles de inferencia directamente
- [[topic-customer-owned-graph-ip]] — los pesos del adaptador por inquilino son propiedad del cliente
- [[topic-knowledge-graph-grounded-apprenticeship]] — las tuplas de entrenamiento llevan contexto de grafo cuando el Portero fundamenta la solicitud
