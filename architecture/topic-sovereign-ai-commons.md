...
slug: topic-sovereign-ai-commons
...
cites: []
paired_with: topic-sovereign-ai-commons.es.md
---
...
The architecture specification is in the [[compounding-substrate]] article. The economic structure is in [[topic-economic-model]]. This article is the market-positioning frame: who the commons serves, what makes it structurally distinct, and what PointSav's role within it is.
...
- [[topic-economic-model]] — the two-tier commercial structure that funds the commons
- [[topic-llm-substrate-decision]] — why OLMo 3 enables the continued-pretraining path
- [[topic-four-tier-slm-substrate]] — the four deployment tiers customers move through
