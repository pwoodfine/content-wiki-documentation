...
slug: topic-vertical-seed-packs-marketplace
...
cites: []
paired_with: topic-vertical-seed-packs-marketplace.es.md
---
...
The [[topic-customer-owned-graph-ip]] principle applies at the instance level, not the pack level: the customer's running knowledge graph (their customized instance of a pack) is their intellectual property; the pack itself is permissively licensed material that the customer customized from.

## Composition

Vertical Seed Packs are the distribution mechanism for the [[topic-seed-taxonomy-as-smb-bootstrap]] pattern — they carry the canonical form of the four-part taxonomy for a specific industry. The planned [[topic-reverse-flow-substrate]] marketplace is intended to include packs as first-class inventory alongside data listings and adapter weights.

## See Also

- [[topic-seed-taxonomy-as-smb-bootstrap]] — the four-part taxonomy structure that packs instantiate
- [[topic-customer-owned-graph-ip]] — the customer's customized instance is their IP; the pack itself is licensed
- [[topic-reverse-flow-substrate]] — the planned marketplace gateway that would distribute packs
- [[topic-mcp-substrate-protocol]] — pack MCP server extensions plug into the Doorman's tool discovery
