...
cites: []
paired_with: topic-meta-repo-pattern.es.md
---
...
- [[topic-knowledge-commons]] — the public-side artifacts the workspace meta-repo publishes per Doctrine MINOR bump
