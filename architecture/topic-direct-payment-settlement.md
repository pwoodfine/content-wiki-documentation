...
slug: topic-direct-payment-settlement
...
cites: []
paired_with: topic-direct-payment-settlement.es.md
---
...
Tenant onboarding is not planned to require any upfront payment to Foundry. Foundry is intended to earn only when the tenant earns. This aligns with the [[topic-customer-owned-graph-ip]] principle: the customer's data and adapters are their property; Foundry is planned to take a service fee on monetization activity, not a license fee on access to the customer's own records.
...
Direct-Payment Settlement composes with the [[topic-reverse-flow-substrate]] — every marketplace and ad exchange transaction is intended to trigger a settlement event. It composes with [[topic-customer-owned-graph-ip]] — revenue from monetizing customer-owned intellectual property flows to the IP holder. And it composes with [[topic-single-boundary-compute-discipline]] — settlement traffic is intended to route through the Doorman so that the same audit boundary captures monetization as well as inference.

## See Also

- [[topic-reverse-flow-substrate]] — the planned marketplace and ad exchange flows that generate settlement events
- [[topic-customer-owned-graph-ip]] — the ownership principle that makes customer-direct payment the correct model
- [[topic-single-boundary-compute-discipline]] — the Doorman as the intended settlement audit boundary
