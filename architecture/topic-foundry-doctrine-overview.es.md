...
slug: topic-foundry-doctrine-overview.es
...
cites:
  ...
  - mcp-spec
  - olmo3-allenai
paired_with: topic-foundry-doctrine-overview.md
---
...
- [[topic-adapter-composition]] — el Álgebra de Composición de Adaptadores (Afirmación #22)
- [[topic-knowledge-commons]] — el modelo de Conocimiento Común / Comercio de Servicios (Afirmación #23)
- [[topic-system-substrate-doctrine]] — el Registro de Capacidades y el Sustrato Soberano de Dos Bases (Afirmaciones #33, #34)
