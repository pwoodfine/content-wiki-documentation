...
slug: topic-seed-taxonomy-as-smb-bootstrap
...
cites: []
paired_with: topic-seed-taxonomy-as-smb-bootstrap.es.md
---
...
The [[topic-knowledge-graph-grounded-apprenticeship]] pattern depends on this seeded graph: the graph provides the grounding context for every subsequent inference request.

## See Also

- [[topic-vertical-seed-packs-marketplace]] — industry-specific packs that populate the seed taxonomy at provisioning
- [[topic-knowledge-graph-grounded-apprenticeship]] — the seeded graph is the grounding source for inference
- [[topic-customer-owned-graph-ip]] — the customer's customized taxonomy is their intellectual property
