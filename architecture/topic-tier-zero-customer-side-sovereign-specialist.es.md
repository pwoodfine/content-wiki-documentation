...
slug: topic-tier-zero-customer-side-sovereign-specialist.es
...
cites: []
paired_with: topic-tier-zero-customer-side-sovereign-specialist.md
---
...
- [[topic-substrate-without-inference-base-case]] — operación determinística cuando todos los niveles de IA no están disponibles
- [[topic-single-boundary-compute-discipline]] — toda la inferencia, incluido el especialista local, pasa por el Portero
- [[topic-seed-taxonomy-as-smb-bootstrap]] — la taxonomía por inquilino con la que arranca el despliegue del Nivel 0
