...
slug: topic-meta-repo-pattern.es
...
cites: []
paired_with: topic-meta-repo-pattern.md
---
...
- [[topic-knowledge-commons]] — los artefactos del lado público que el meta-repositorio del espacio de trabajo publica
