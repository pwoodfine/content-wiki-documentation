...
slug: topic-service-slm-operationalization-plan
category: reference
type: topic
quality: published
...
cites: []
paired_with: topic-service-slm-operationalization-plan.es.md
---
...
- [[topic-reverse-funnel-editorial-pattern]] — The editorial pipeline that generates the craft preference pairs consumed by Stage-2 training.
- [[topic-tier-c-key-wiring]] — The operational form of Tier C external API key management.
