...
slug: topic-customer-first-ordering
category: reference
type: topic
quality: published
...
cites: []
paired_with: topic-customer-first-ordering.es.md
---
...
- [[topic-compounding-substrate]] — the substrate architecture this principle serves
- [[topic-data-vault-bookkeeping-substrate]] — an example of a product built in customer-installation order
