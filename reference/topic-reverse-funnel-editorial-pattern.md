...
- [[topic-project-tetrad-discipline]] — The wiki leg of the Tetrad is what generates bulk draft input for this pipeline.
- [[topic-service-slm-operationalization-plan]] — The operational plan for bringing the substrate model into active use as a draft generator.
- [[topic-wikipedia-leapfrog-pattern]] — How Wikipedia's editorial structures map to substrate-enforced equivalents.
