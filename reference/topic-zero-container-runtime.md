...
slug: topic-zero-container-runtime
category: reference
type: topic
quality: published
...
cites: []
paired_with: topic-zero-container-runtime.es.md
---
...
- [[topic-service-slm-operationalization-plan]] — The compute routing architecture that applies this principle across Tier A, B, and C.
