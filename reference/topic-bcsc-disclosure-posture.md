...
slug: topic-bcsc-disclosure-posture
category: reference
type: topic
quality: published
...
cites:
  - ni-51-102
  - osc-sn-51-721
paired_with: topic-bcsc-disclosure-posture.es.md
---
...
- [[topic-citation-substrate]] — the citation graph that makes regulatory grounding machine-readable
- [[topic-draft-research-trail-discipline]] — how forward-looking research items are scrubbed at refinement time
- [[topic-cluster-wiki-draft-pipeline]] — the editorial pipeline where this posture is applied uniformly
