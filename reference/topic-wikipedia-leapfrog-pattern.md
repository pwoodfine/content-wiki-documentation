...
slug: topic-wikipedia-leapfrog-pattern
category: reference
type: topic
quality: published
...
cites: []
paired_with: topic-wikipedia-leapfrog-pattern.es.md
---
...
- [[topic-reverse-funnel-editorial-pattern]] — The editorial cycle that produces the training-signal provenance records described in the attribution section.
- [[topic-wiki-provider-landscape]] — A structural audit of twenty-five wiki and knowledge-base providers in 2026, with the gap analysis that contextualises these leapfrog claims.
