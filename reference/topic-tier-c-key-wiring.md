...
cites: []
paired_with: topic-tier-c-key-wiring.es.md
---
...
- [[topic-service-slm-operationalization-plan]] — The broader compute routing architecture that defines the Tier A, B, and C structure.
