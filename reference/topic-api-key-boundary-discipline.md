...
slug: topic-api-key-boundary-discipline
category: reference
type: topic
quality: published
...
cites:
  - ni-51-102
paired_with: topic-api-key-boundary-discipline.es.md
---
...
- [[topic-compounding-substrate]] — the three-ring architecture this discipline is embedded in
- [[topic-design-system-substrate]] — the design system substrate, which routes AI-readable research through the same gateway boundary
- [[topic-cluster-wiki-draft-pipeline]] — the editorial pipeline, whose inference calls route through the gateway
