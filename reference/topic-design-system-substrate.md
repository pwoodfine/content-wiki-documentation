...
- [[topic-data-vault-bookkeeping-substrate]] — the parallel vault-as-canonical architecture for financial records
- [[topic-cluster-design-draft-pipeline]] — the pipeline that routes design contributions into this substrate
- [[topic-compounding-substrate]] — the broader substrate sovereignty pattern
